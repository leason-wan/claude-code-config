...
class ClaudeCodeRouterConfig {
  ...
  getMessages() {
    const messages = {
      zh: {
        ...
        envKeyDetected: "🔑 检测到环境变量 MODELSCOPE_API_KEY，将使用环境变量中的 API Key",
        envKeyNotFound: "⚠️  未检测到环境变量 MODELSCOPE_API_KEY，将使用默认配置",
        configComplete: "✅ claude-code-router 配置完成！",
        configLocation: "📁 配置文件位置:",
        usage: "📝 使用说明:",
        step1: "1. 请确保已安装 @anthropic-ai/claude-code",
        step2: "2. 请确保已安装 @leason/claude-code-router",
        step3Warning: "3. ⚠️  请手动配置环境变量MODELSCOPE_API_KEY:",
        ...
        promptApiKey: "请输入您的 ModelScope API Key:",
        apiKeyPrompt: "ModelScope API Key",
        ...
        editConfigInstructions: [
          ...
          `   # 将 "api_key" 字段替换为你的 ModelScope API Key`
        ]
      },
      en: {
        configuring: "🚀 Configuring claude-code-router...",
        envKeyDetected: "🔑 MODELSCOPE_API_KEY environment variable detected, will use API Key from environment",
        envKeyNotFound: "⚠️  MODELSCOPE_API_KEY environment variable not found, will use default configuration",
        ...
        step2: "2. Please ensure @leason/claude-code-router is installed",
        step3Warning: "3. ⚠️  Please manually set your MODELSCOPE_API_KEY environment variable:",
        ...
        promptApiKey: "Please enter your ModelScope API Key:",
        apiKeyPrompt: "ModelScope API Key",
        ...
        editConfigInstructions: [
          ...
          `   # Replace the "api_key" field with your ModelScope API Key`
        ]
      }
    };
  ...
  async setup() {
    try {
      ...
      // 检查环境变量
      let apiKey = process.env.MODELSCOPE_API_KEY;
  ...
  async createTransformerFile() {
    const transformerContent = `class ModelScopeTransformer {
  name = "modelscope";
...
module.exports = ModelScopeTransformer;`;
